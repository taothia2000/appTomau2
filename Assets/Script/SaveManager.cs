...
public class SaveManager : MonoBehaviour
{
    ...
    // Xóa hàm CleanupCache - không ảnh hưởng đến chạy
    ...
    {
        // Xóa hàm ClearCache ở đây, không ảnh hưởng đến chạy
    }

    // Xóa hàm ClearUnusedTextures - không ảnh hưởng đến chạy
    ...
    // Xóa hàm ClearCache - không ảnh hưởng đến chạy

    // Xóa hàm LogMemoryUsage - chỉ sử dụng khi debug
    
    // Xóa hàm LimitCacheSize - không ảnh hưởng đến chạy
    ...
    public void PrepareForSceneChange()
    {
        ...
        // Xóa Resources.UnloadUnusedAssets() không ảnh hưởng tới chức năng chính
    }
}